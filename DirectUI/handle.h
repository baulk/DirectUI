...
public:
  ...
  explicit operator bool() const throw() { return m_value != Traits::invalid(); }
  ...
  auto swap(unique_handle<Traits> &other) throw() -> void { std::swap(m_value, other.m_value); }
};
...
struct null_handle_traits {
  ...
  static auto close(pointer value) throw() -> void { VERIFY(CloseHandle(value)); }
};
