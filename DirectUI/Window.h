...
public:
  ...
  static Window *GetCurrent() { return _current; }

  virtual ~Window() { ReleaseDevice(); }
...
protected:
  ...
  UIElement *HitTestCore(const DX::Point2F &point) override { return nullptr; }

  DX::Direct2D::DeviceContext &GetDeviceContext() { return _dc; }

  DX::Dxgi::SwapChain1 &GetSwapChain() { return _swapChain; }
