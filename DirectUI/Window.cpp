...
Window::Window(const wchar_t *title) {
  _hWnd =
      ::CreateWindowW(DirectUIWindowClassName, title, WS_OVERLAPPEDWINDOW | WS_VISIBLE, CW_USEDEFAULT, CW_USEDEFAULT,
...
void Window::Invalidate() { ::InvalidateRect(_hWnd, nullptr, FALSE); }
