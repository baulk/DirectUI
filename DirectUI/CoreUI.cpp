...
DEFINE_DP_WITH_FLAGS(UIElement, Visibility, VisibilityType, VisibilityType::Visible,
                     PropertyMetadataFlags::AffectsRender | PropertyMetadataFlags::AffectsLayout);
...
DEFINE_DP_WITH_FLAGS(UIElement, HorizontalAlignment, HorizontalAlignmentType, HorizontalAlignmentType::Stretch,
                     PropertyMetadataFlags::AffectsLayout);
DEFINE_DP_WITH_FLAGS(UIElement, VerticalAlignment, VerticalAlignmentType, VerticalAlignmentType::Stretch,
                     PropertyMetadataFlags::AffectsLayout);
DEFINE_DP(UIElement, UserData, PVOID, nullptr);

DEFINE_DP_WITH_FLAGS(UIElement, FontSize, float, 12.0f,
                     PropertyMetadataFlags::AffectsRender | PropertyMetadataFlags::AffectsLayout |
                         PropertyMetadataFlags::Inherit);
DEFINE_DP_WITH_FLAGS(UIElement, FontFamily, std::wstring, L"Arial",
                     PropertyMetadataFlags::AffectsRender | PropertyMetadataFlags::Inherit);
DEFINE_DP_WITH_FLAGS(UIElement, FontWeight, DirectWrite::FontWeight, DirectWrite::FontWeight::Normal,
                     PropertyMetadataFlags::AffectsRender);
DEFINE_DP_WITH_FLAGS(UIElement, FontStyle, DirectWrite::FontStyle, DirectWrite::FontStyle::Normal,
                     PropertyMetadataFlags::AffectsRender);
...
DEFINE_DP_WITH_FLAGS(ContentControl, Content, Ref<UIElement>, nullptr,
                     PropertyMetadataFlags::AffectsRender | PropertyMetadataFlags::AffectsLayout);
...
ContentControl::ContentControl() {
  ContentProperty.RegisterPropertyChangedHandler(*this,
                                                 [this](auto &, auto &, const auto &oldValue, const auto &newValue) {
                                                   if (oldValue)
