...
void Application::CreateDeviceSwapChainBitmap(const DX::Dxgi::SwapChain &swapChain,
...
bool DirectUI::Application::ResizeSwapChainBitmap(DX::Direct2D::DeviceContext &target) { return false; }
...
bool Application::CreateDeviceContextAndSwapChain(HWND hWnd, DX::Direct2D::DeviceContext &dc,
                                                  DX::Dxgi::SwapChain1 &swapChain) {
  using namespace DX;
...
void Application::OnInit() { ::CoInitialize(nullptr); }

void Application::OnExit() { ::CoUninitialize(); }
